# pas.plugins.identity (@plone-collective/volto-identity)
...
[![](https://img.shields.io/badge/-Storybook-ff4785?logo=Storybook&logoColor=white&style=flat-square)](https://collective.github.io/volto-identity/)
...
Add `@plone-collective/volto-identity` to your `volto.config.js`.
...
```javascript
const theme = '@plone-collective/volto-identity';
```
...
yo @plone/volto my-volto-project --addon @plone-collective/volto-identity
cd my-volto-project
```
