 ...
 * `@plone/volto/components/manage/Toolbar/PersonalTools.jsx` with the changes
 ...
 * pluggable here is `toolbar-user-menu`, at the end of the menu *list*, so
 * the avatar block above it cannot be replaced without replacing this
 * component.
 *
 * WHAT CHANGED:
 * - the `.avatar` block is gone. It drew a 96px portrait, or a camera icon
 *   for the many users who have none -- the same picture for everybody,
 *   saying "no image here" rather than "this is you". Who is signed in is
 *   now shown by `<UserAvatar>` on the toolbar button that opens this menu,
 *   where it is visible without opening anything;
 * - the imports that block alone used are gone with it: `Image`,
 *   `cameraSVG`, `expandToBackendURL`, and the `userAvatar` message.
 */
