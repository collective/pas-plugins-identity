/**
 * COPIED FROM VOLTO 19.3.0.
 *
 * Takes Volto's place through
 * `customizations/volto/components/manage/Toolbar/Toolbar`, which is where
 * the reason for shadowing it is written down.
 *
 ...
 * and re-apply only these changes. It is the one component here that has not
 * been rewritten as ours -- until it is, `.jsx` and a literal diff are what
 * make the upgrade tractable.
 *
 * WHAT CHANGED:
