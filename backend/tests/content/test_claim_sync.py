...
user and stopped there. On a site with the ``[content]`` layer the Plone user
...
from pas.plugins.identity.content.subscribers import claim_fields
from pas.plugins.identity.content.subscribers import DEFAULT_CLAIM_FIELDS
from pas.plugins.identity.content.subscribers import sync_claims
