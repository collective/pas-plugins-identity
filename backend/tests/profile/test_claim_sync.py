...
user and stopped there. On a site with the ``[profile]`` layer the Plone user
...
from pas.plugins.identity.profile.subscribers import claim_fields
from pas.plugins.identity.profile.subscribers import DEFAULT_CLAIM_FIELDS
from pas.plugins.identity.profile.subscribers import sync_claims
