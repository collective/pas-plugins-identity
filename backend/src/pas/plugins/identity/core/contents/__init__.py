...
Their markers are applied in ``..configure.zcml`` against the class rather
than through the FTI, so a test that instantiates one directly gets the same
subscribers a real object does.
"""
