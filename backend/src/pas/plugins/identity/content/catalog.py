...
from pas.plugins.identity.content.interfaces import IIdentityProfileCatalog
...
#: by the indexer in :mod:`pas.plugins.identity.content.indexing` and must be
...
class IdentityProfileCatalog(CatalogTool):
    ...
    def clearFindAndRebuild(self) -> None:
        ...
        :mod:`~pas.plugins.identity.content.doctor` finding, not something a
