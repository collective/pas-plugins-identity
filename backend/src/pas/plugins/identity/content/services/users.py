...
The ``[content]`` layer decided that a user's picture lives on their Profile
...
Registered for :class:`~pas.plugins.identity.content.interfaces.IIdentityContentLayer`,
