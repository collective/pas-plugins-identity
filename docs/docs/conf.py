...
# Multi-provider external authentication for Plone build configuration file
...
from pas.plugins.identity import __version__
...
project = "Multi-provider external authentication for Plone"
...
linkcheck_ignore = [
    ...
    r"http://127.0.0.1",
    r"http://localhost",
    # The federation demo runs on sibling .localhost hosts, which only
    # resolve while the demo stack is up.
    r"^https?://[^/]*\.localhost",
    # TODO: remove once the repository is published. Until then every
    # github.com/collective/pas-plugins-identity URL answers 404.
    r"^https://github\.com/collective/pas-plugins-identity/blob/",
    # Ignore file downloads
    r"^/_static/",
    # Ignore pages that require authentication
    r"https://github.com/collective/pas-plugins-identity/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/pas-plugins-identity",
    ...
    "logo": {
        "text": "Multi-provider external authentication for Plone",
    },
    "navigation_with_keys": True,
    "path_to_docs": "docs/docs",
    "repository_branch": "main",
    "repository_url": "https://github.com/collective/pas-plugins-identity",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/pas-plugins-identity/edit/main/docs/",
# }

# Announce that we have an opensearch plugin
# https://www.sphinx-doc.org/en/master/usage/configuration.html#confval-html_use_opensearch
html_use_opensearch = "https://collective.github.io/pas-plugins-identity"
...
html_baseurl = "https://collective.github.io/pas-plugins-identity/"
...
ogp_site_url = "https://collective.github.io/pas-plugins-identity/"
ogp_description_length = 200
ogp_image = "https://collective.github.io/pas-plugins-identity/_static/logo.svg"
ogp_site_name = "Multi-provider external authentication for Plone Documentation"
ogp_type = "website"
...
htmlhelp_basename = "Multi-provider external authentication for Plone Documentation"
...
latex_documents = [
    (
        "index",
        "Multi-provider external authentication for PloneDocumentation.tex",
        "Multi-provider external authentication for Plone Documentation",
