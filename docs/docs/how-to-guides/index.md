...
myst:
  html_meta:
    ...
    "keywords": "Plone, pas.plugins.identity, how-to, install, configure, migrate"
---
...
If you want to understand why something works the way it does, read {doc}`/concepts/index` instead.
